...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\chintu\OneDrive\Desktop\student\Python_Test_Projects\Images_GUI\insta.jpg")
        ...
        det_img_btn=Image.open(r"C:\Users\chintu\OneDrive\Desktop\student\Python_Test_Projects\Images_GUI\fb.png")
        ...
        att_img_btn=Image.open(r"C:\Users\chintu\OneDrive\Desktop\student\Python_Test_Projects\Images_GUI\yt.png")
        ...
        hlp_img_btn=Image.open(r"C:\Users\chintu\OneDrive\Desktop\student\Python_Test_Projects\Images_GUI\gmail.png")
    ...
    def instagram(self):
        self.new = 1
        self.url = "https://www.instagram.com/__mahendar__4?igsh=MWo0NzF3am0wdmtjYw=="
        webbrowser.open(self.url,new=self.new)
    
    def facebook(self):
        self.new = 1
        self.url = "https://www.facebook.com/share/19H3U34Xqw/"
        webbrowser.open(self.url,new=self.new)
    
    def youtube(self):
        self.new = 1
        self.url = "https://www.youtube.com/channel/@chandrapalreddy3403?si=6NkGLdCYm4K7duWO"
        webbrowser.open(self.url,new=self.new)
    
    def gmail(self):
        self.new = 1
        self.url = "mailto:viveknandareddy26@gmail.com"
        webbrowser.open(self.url,new=self.new)
